        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form action="{{route('admin.jobs.update',$job->id)}}" method="POST" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row"
                        >
                        @csrf
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="vendor" class="form-control mb-2"
                                            placeholder="Vendor" value="{{$job->vendor}}" />
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="date" name="date" class="form-control mb-2"
                                            placeholder="Date"  value="{{$job->date}}"/>
                                        <!--end::Input-->  
                                    </div>
                                    <!--end::Input group-->
                                     <!--begin::Input group-->
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="hiring" class="form-control mb-2"
                                            placeholder="Hiring"  value="{{$job->hiring}}"/>
                                        <!--end::Input-->  
                                    </div>
                                    <!--end::Input group-->
                                     <!--begin::Input group-->
                                    ...
                                    <div>
                                        ...
                                        <!--end::Editor-->
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Set a description to the job for better
                                            visibility.</div>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="location" class="form-control mb-2"
                                            placeholder="Location" value="{{$job->location}}"/>
                                        <!--end::Input-->  
                                    </div>
                                </div>
                                <!--end::Card header-->
