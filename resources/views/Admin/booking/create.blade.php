        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form action="{{route('admin.bookings.store')}}" method="POST"  enctype="multipart/form-data" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row">
                         @csrf
                                    ...
                                    <div class="fv-row">
                                     ...
                                     <div class="fv-row">
                                        ...
                                        <input type="text" name="tournament_title" class="form-control mb-2"
                                            placeholder="Tournament Title" value="" />
                                        <!--end::Input-->
