        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form action="{{route('admin.reviews.update',$review->id)}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row">
                        @csrf
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select class="form-control" name="tournament_id">
                                            ...
                                            @foreach ($tournaments as $tournament)
                                                <option value="{{$tournament->id}}" @if($tournament->id==$review->tournament_id) selected @endif>{{ $tournament->title }}</option>
                                            @endforeach    
                                        </select>
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select class="form-control" name="user_id">
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{$user->id}}" @if($user->id==$review->user_id) selected @endif>{{ $user->name }}</option>
                                            @endforeach    
                                        </select>
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <input type="number" name="rating" class="form-control mb-2"
                                            placeholder="Ratingat" value="{{$review->rating}}" />
                                        <!--end::Input-->
