                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body text-center pt-0">
                                    ...
                                    <div class="image-input-wrapper w-150px h-150px" style="background-image: url('http://127.0.0.1:8000/storage/{{ $home->banner_img }}')">
                                    </div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body text-center pt-0">
                                    ...
                                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                        data-kt-image-input="true">
                                    <div class="image-input-wrapper w-150px h-150px" style="background-image: url('http://127.0.0.1:8000/storage/{{ $home->resource_img }}')">
                                    </div>
