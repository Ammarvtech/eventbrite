        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form action="{{route('admin.faq.update',$faq->id)}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row">
                        @csrf
                        <!--begin::Aside column-->
                                ...
                                <div class="card-body pt-0">
                                    <!--begin::Select2-->
                                     <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                        ...
                                        <option value="0" @if($faq->is_active ==0) selected @endif >Active</option>
                                        <option value="1" @if($faq->is_active ==1) selected @endif>Inactive</option>
                                    </select>
                                    <!--end::Select2-->
                                    <!--begin::Description-->
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <input type="text" class="form-control mb-2" name="meta_title"
                                            placeholder="Meta tag name" value="{{$faq->meta_title}}" />
                                        <!--end::Input-->
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div id="kt_ecommerce_add_category_meta_description"
                                             ...
                                             <textarea name="meta_description" class="form-control">{{$faq->meta_description}}</textarea>
                                        </div>
                                        <!--end::Editor-->
                                    ...
                                    <div>
                                        ...
                                        <input id="kt_ecommerce_add_category_meta_keywords"
                                            class="form-control mb-2" name="meta_keywords" value="{{$faq->meta_keywords}}" />
                                        <!--end::Editor-->
                                        <!--begin::Description-->
