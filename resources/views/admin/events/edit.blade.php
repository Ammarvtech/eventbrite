        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form action="{{route('admin.events.update',$event->id)}}" method="POST" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row"
                        >
                        @csrf
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="vendor" class="form-control mb-2"
                                            placeholder="Vendor" value="{{$event->vendor}}" />
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="date" name="date" class="form-control mb-2"
                                            placeholder="Vendor" value="{{$event->date}}" />
                                        <!--end::Input-->  
                                    </div>
                                    <!--end::Input group-->
                                     <!--begin::Input group-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="duration" class="form-control mb-2"
                                            placeholder="Duration" value="{{$event->duration}}" />
                                        <!--end::Input-->  
                                    </div>
                                    <!--end::Input group-->
                                     <!--begin::Input group-->
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="location" class="form-control mb-2"
                                            placeholder="Location" value="{{$event->location}}" />
                                        <!--end::Input-->  
                                    </div>
                                     <!--begin::Input group-->
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="deals" class="form-control mb-2"
                                            placeholder="Deals" value="{{$event->deals}}" />
                                        <!--end::Input-->  
                                    </div>
                                    <!--end::Input group-->
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select class="form-control" name="event_category">
                                            ...
                                            <option value="{{$cat->id}}"  @if($event->event_category_id==$cat->id) selected @endif>{{$cat->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <!--end::Input group-->
                                     <div class="mb-10 fv-row">
                                        ...
                                        <select class="form-control" name="shipping">
                                            ...
                                            <option value="1" @if($event->shipping==1) selected @endif>Free</option>
                                            <option value="2" @if($event->shipping==2) selected @endif>Buyer Pay</option>
                                            <option value="3" @if($event->shipping==3) selected @endif>Seller Pay</option>
                                        </select>
