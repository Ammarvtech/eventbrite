<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <a href="../../demo1/dist/index.html">
            <img alt="Logo" src="{{ url('admin/') }}/assets/media/logos/default-dark.svg"
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('admin.tournaments.index') }}">
                                ...
                                <span class="menu-title">Manage Tournaments</span>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('admin.event-categories.index') }}">
                                ...
                                <span class="menu-title">Manage Event Category</span>
                            </a>
                        </div>
                    </div>
                </div>
