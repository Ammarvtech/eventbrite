                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    @foreach ($banners as $banner)
                                        <tr>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <a href="#" class="symbol symbol-50px">
                                                        <span class="symbol-label"
                                                            style="background-image:url({{ $banner->image }});"></span>
                                                    </a>
                                                    <!--end::Thumbnail-->
                                                    <div class="ms-5">
                                                        <!--begin::Title-->
                                                        <a href="#"
                                                            ...
                                                            data-kt-ecommerce-category-filter="category_name">{{ $banner->title }}</a>
                                                        <!--end::Title-->
                                                        <!--begin::Description-->
                                                        <div class="text-muted fs-7 fw-bold">{{ $banner->description }}
                                                        </div>
                                                        <!--end::Description-->
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                <div class="badge badge-light-primary">{{ $banner->created_at }}</div>
                                            </td>
                                            <!--end::Type=-->
                                            <!--begin::Action=-->
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="javascript::" onclick="deleteRecord('{{ route('admin.banners.delete', $banner->id) }}')"
