...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\NumberOfTeam>
 */
class NumberOfTeamFactory extends Factory
{
    /**
    ...
    {
        return [
            'number_of_teams' => fake()->unique()->word,
            'created_by' => null,
            'updated_by' => null,
            'deleted_by' => null,
